...
file = read.csv(paste0(path_out,'a002_01_rewrite_supplementfig2_contribution_yearly_rates_accounting_for_on-route_changes.csv')) 
...
tiff(
  filename = paste(path_pic,"a002_02_rewrite_supplement_figure2.tiff", sep = ""),
  width = pic_width,
  height = pic_height,
  units = "cm",
  pointsize = 10,
...
nrow = 3;ncol = 5;
width = 0.16;height = 0.26;
xstart=0.03;ystart=0.97;
break1=0.04;break2 = 0.08
